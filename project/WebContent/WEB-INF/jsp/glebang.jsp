...
<table border="1" cellspacing="1" WIDTH="540">
	<jl:forEach varStatus="vs" var="t" items="${l}">
		...
		<tr bgColor="ccddee">
				<td colspan="2">
					<a href="listbang.do?page=1">목록</a> &nbsp;&nbsp;
					<a href="pluslikebang.do?no=${t.no}">글추천</a> &nbsp;&nbsp;
					<a href="gleupdate1bang.do?no=${t.no}&userId=${t.userId}">수정</a> &nbsp;&nbsp;
					<a href="gledelbang.do?no=${t.no}&userId=${t.userId}">삭제</a> &nbsp;&nbsp;
				</td>
		</tr>
</jl:forEach>
</table>
...
<table border="1" WIDTH="540">
	<jl:forEach varStatus="vs" var="t" items="${l2}">
			<tr>
					...
					<td>${t.theTime} &nbsp;
						${t.clientIp}
						<a href="reupdatebang.do?no=${t.no}&reno=${t.reno}&userId=${t.userId}">수정</a>
						<a href="redelbang.do?no=${t.no}&reno=${t.reno}&userId=${t.userId}">삭제</a>
					</td>
			</tr>
	</jl:forEach>
</table>
